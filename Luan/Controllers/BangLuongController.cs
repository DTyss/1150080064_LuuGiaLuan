...
namespace Luan.Controllers
{
    public class BangLuongController : Controller
    {
...

        {
            ...
            var listOfData = _context.BangLuongs.ToList(); // Lấy tất cả dữ liệu từ bảng HANGHOA
        ...
        public ActionResult Create(Models.BangLuong model)
        {
        ...
        public ActionResult Delete(string id1)
        {
            ...
            Models.BangLuong itemToDelete = _context.BangLuongs.Find(id1);
        ...
        public ActionResult DeleteConfirmed(string id1)
        {
            ...
            _context.BangLuongs.Remove(itemToDelete); // Xóa phần tử
